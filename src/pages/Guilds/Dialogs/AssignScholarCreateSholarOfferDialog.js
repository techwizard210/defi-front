...
const AssignScholarCreateScholarOfferDialog = (props) => {
  const { open, handleClose, wipeSignatureAndReRequest, selectedNft } = props;
          ...
          <Grid container>
            <Grid item container lg={12} md={12} sm={12} xs={12}>
              ...
              >
                {selectedNft && (
                  <>
                    <Grid item lg={2} md={2} sm={3} xs={3} className="image">
                      <img
                    ...
                    >
                      ...
                      >
                        ...
                        Scholar Slots {selectedNft.assignedScholars} /{' '}
                        {selectedNft.scholarSlots}
                      </Grid>
                    </Grid>
                  </>
                )}
...
export default AssignScholarCreateScholarOfferDialog;
